<?php
    ...
    if(isset($users[$username]) && $users[$username]['pwd'] === substr($password_hash, 28)) {
        $_SESSION['session_id'] = '51C6A17C-29F2-45EB-9643-5AFA5FBC114F';
        ...
        if(isset($_SESSION['user_redirect']) && !isset($_SESSION['user_redirect_attempt'])) {
            ...
            $homeURL = 'employee-portal.php';
            $homeURLs = array('0' => 'client-portal.php', '2' => 'employee-portal.php', '3' => 'employee-portal.php');
